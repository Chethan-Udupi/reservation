                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="reservation_save.php" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <input type="number" class="form-control" maxlength="10" placeholder="Contact #" name="contact" required>
                                  </div>
                                </div>
								 ...
								 <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <label class="checkbox-inline">
                                      <input type="checkbox" id="inlineCheckbox1" value="option1" required> I agree to the <a href="#facilities" data-toggle="modal">terms and condtion</a> of the Unique Catering
                                    </label>
									</div>
									</div>
